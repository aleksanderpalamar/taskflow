  ...
  return (
    <div className="flex items-center justify-center flex-col">
      <div className={cn(
        ...
        <div className="text-3xl md:text-6xl bg-gradient-to-r from-fuchsia-600 via-purple-600 to-pink-600 text-white
      ...
      <div className={cn(
        ...
        Collaborate, manage project, and reach new productivity levels.
        From highly, regarded projects to mind-blowing initiatives,
        we accomplish it all with TaskFlow.
      </div>
