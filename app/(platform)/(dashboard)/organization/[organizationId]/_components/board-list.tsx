      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        {boards.map((board) => (
          <Link
            ...
            className="group aspect-video relative h-full w-full bg-no-repeat bg-center 
            bg-cover bg-violet-700 overflow-hidden rounded-sm p-2"
          >
